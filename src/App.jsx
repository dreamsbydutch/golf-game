...
export default function App(){
	...
	if(screen==='admin')return <Admin groups={settings??game.groups} setGroups={setSettings} unlocked={adminUnlocked} onUnlock={()=>setAdminUnlocked(true)} onBack={()=>setScreen('entry')} onSave={async()=>{await saveSettings({password:'Dutchy!4',groups:settings});setScreen('entry')}} onReset={async()=>{await resetRound({password:'Dutchy!4'});setHoleIndex(0);if(groupId)localStorage.setItem(holeKey(groupId),'0');setScreen('entry')}}/>
